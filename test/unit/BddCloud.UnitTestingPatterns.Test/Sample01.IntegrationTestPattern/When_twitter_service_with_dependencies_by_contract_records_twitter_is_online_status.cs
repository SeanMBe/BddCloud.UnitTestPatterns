...
{
    [Specification]
    public class When_twitter_service_with_dependencies_by_contract_records_twitter_is_online_status_and_twitter_is_offline : TwitterServiceWithConcreteDependenciesSpecification
    {
