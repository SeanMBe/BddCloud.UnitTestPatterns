...
{
    public class When_list_of_string_with_ilist_contract_has_item_inserted_at_first_position : ListOfStringSpecificationWithIListContract
    {
        ...
        protected override void GivenThat()
        {
            ...
            _expected = Enumerable.Create("expected", "first", "second", "third");
        }

        protected override void WhenIRun()
        {
            Sut.Insert(0, _expected.First());
        }
