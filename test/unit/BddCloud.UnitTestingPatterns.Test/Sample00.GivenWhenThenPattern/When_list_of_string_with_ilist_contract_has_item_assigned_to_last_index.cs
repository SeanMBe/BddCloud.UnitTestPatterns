...
{
    public class When_list_of_string_with_ilist_contract_has_item_assigned_to_last_index : ListOfStringSpecificationWithIListContract
    {
        ...
        protected override void GivenThat()
        {
            ...
            _expected = Enumerable.Create("first", "second", "expected");
        }

        protected override void WhenIRun()
        {
            Sut[Enumerable.Count(InitialItems) - 1] = _expected.Last();
        }
